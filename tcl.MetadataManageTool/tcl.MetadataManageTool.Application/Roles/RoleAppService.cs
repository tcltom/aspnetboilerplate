...
namespace tcl.MetadataManageTool.Roles
{
    ...
    public class RoleAppService : AsyncCrudAppService<Role, RoleDto, int, PagedResultRequestDto, CreateRoleDto, RoleDto>, IRoleAppService
    {
        ...
        protected override ISugarQueryable<Role> CreateFilteredQuery(PagedResultRequestDto input)
        {
        ...
        {
            return await Repository.GetAll().FirstAsync(x => x.Id == id);//.GetAllIncluding(x => x.Permissions)
        }

        protected override ISugarQueryable<Role> ApplySorting(ISugarQueryable<Role> query, PagedResultRequestDto input)
        {
