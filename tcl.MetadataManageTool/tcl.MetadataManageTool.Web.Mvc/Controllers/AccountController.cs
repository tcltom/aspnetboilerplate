...
using tcl.MetadataManageTool.Web.Models.Account;
using tcl.MetadataManageTool.Web.Views.Shared.Components.TenantChange;

namespace tcl.MetadataManageTool.Web.Controllers
{
    public class AccountController : MetadataManageToolControllerBase
    {
